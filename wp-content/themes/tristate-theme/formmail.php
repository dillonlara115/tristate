...
$TARGET_EMAIL = array(EMAIL_NAME."@russellmanagement\.com$",
		      EMAIL_NAME."@choicemarketing\.biz$",
		      EMAIL_NAME."@gmail\.com$",
                      EMAIL_NAME."@blackdogproductions\.net$");

            /* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","exec.director@tristatesign.org");
...
function LoadBuiltinLanguage()
{
    ...
    $aMessages[MSG_FM_ALERT] = 'FormMail alert';
        ...
        // Parameters: none
    $aMessages[MSG_FM_ERROR] = 'Sign Expo Registration';

        // MSG_FM_ERROR_LINE is sent in an Alert message on a
        // separate line to introduce the actual error message
        // Parameters: none
    $aMessages[MSG_FM_ERROR_LINE] = 'Registration Information Below:';
...
if (!isset($SPECIAL_VALUES["recipients"]) || empty($SPECIAL_VALUES["recipients"]))
{
    ...
    if (!$bDoneSomething)
        if (!$bGotGoBack && !$bGotNextForm)
            ErrorWithIgnore("Expo Registration",GetMessage(MSG_NO_ACTIONS));
}
else
{
        //
