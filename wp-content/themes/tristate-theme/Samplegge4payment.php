...
<?php
$x_login = "WSP-TRI-S-xeuPSwBItw"; // Take from Payment Page ID in Payment Pages interface
$transaction_key = "am0jOqgSrp9SEyq9MWN3"; // Take from Payment Pages configuration interface
